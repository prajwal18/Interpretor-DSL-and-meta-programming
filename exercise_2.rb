require './filters/exercise2_expression'
...
result1 = exp.matches('*.mp3').evaluate('dir')
...
result6 = (
  (exp.matches('*.mp3') & (exp < 500)) | exp.matches('*.md')
).evaluate('dir')
print_list(result6)
puts "--------------------------\n\n"
...
result9 = (
  exp.matches('*.css') | exp.matches('*.html') | exp.matches('*.js')
).evaluate('dir')
print_list(result9)
puts "--------------------------\n\n"
